...
This is BlazePose Distillation to student model for <b>more light with few dataset. And for getting almost equal to or more high performance than teacher model.</b>
